...
- Square inventory-aware availability. Tracked items at or below their location-specific alert threshold show a visible `Low stock · 2 left` badge, and the remaining quantity is enforced in the cart and rechecked before checkout.
